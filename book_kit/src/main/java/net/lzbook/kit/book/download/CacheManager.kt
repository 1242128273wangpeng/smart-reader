    ...
    object innerListener {
        ...
        fun onTaskFailed(book_id: String?, t: Throwable) {
            ...
            if (bookTask != null) {
                ...
                StartLogClickUtil.upLoadEventLog(CacheManager.app, StartLogClickUtil.SYSTEM_PAGE, StartLogClickUtil.CASHERESULT, data)
...
//                saveTaskInfo(bookTask)
        ...
        fun onTaskFinish(book_id: String) {
            ...
            if (bookTask != null) {
                ...
                data.put("cache_chapters", "" + bookTask.cache_chapters)
                data.put("cache_times", "" + bookTask.cache_times)
                StartLogClickUtil.upLoadEventLog(CacheManager.app, StartLogClickUtil.SYSTEM_PAGE
