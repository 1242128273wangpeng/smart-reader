package net.lzbook.kit.encrypt.v17.rating;
...
public class Rating {
	...
	public static int doTextRate(String textString) {
		Map<String, Integer> map = new HashMap<String, Integer>();
		/**
		 * 获取各种字符的个数
		 */
		...
		int otherCharacter = map.get("otherCharacter");
		//计算得分
		return chCharacter * Properties.CNCHARSCORE + chPunctuationCharacter * Properties.CNPNCHARSCORE
				+ otherCharacter / 5;
	}
