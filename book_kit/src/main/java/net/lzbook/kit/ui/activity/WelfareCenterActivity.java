...
public class WelfareCenterActivity extends FrameActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        int backId=AppUtils.getDrawableByName(this,"welfare_center_back");
        if(backId!=-1) {
            welfare_center_back.setImageResource(backId);
        }
        int searchId=AppUtils.getDrawableByName(this,"welfare_center_search");
        if(searchId!=-1) {
            welfare_center_search.setImageResource(searchId);
        }
        initListener();
    ...
    private void initJSHelp() {
        ...
        jsInterfaceHelper.setOnGameAppClick(new JSInterfaceHelper.onGameAppClick() {
            ...
            public void downloadGame(String url, String name) {
                ...
                Intent intent = new Intent(BaseBookApplication.getGlobalContext(), DownloadAPKService.class);
    ...
    public void onClick(View view) {
        if(view.getId()==R.id.welfare_center_back){
            clickBackBtn();
        }else if(view.getId()==R.id.welfare_center_search){
