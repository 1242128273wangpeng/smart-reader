...
class BookShelfFragment : Fragment(), UpdateCallBack, BookShelfView, MenuManager {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(SPUtils.getDefaultSharedBoolean(SPKey.BOOKSHELF_PERSON_RED,false)){
            redpoint_home_setting?.visibility = View.GONE
        }
    ...
    override fun onBookDelete(onlyDeleteCache: Boolean) {
        ...
        dismissRemoveMenu()
        ToastUtil.showToastMessage(if (onlyDeleteCache) R.string.bookshelf_delete_cache_success else R.string.bookshelf_delete_success)
    }
