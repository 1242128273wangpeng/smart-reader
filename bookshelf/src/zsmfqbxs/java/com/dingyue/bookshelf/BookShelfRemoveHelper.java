...
public class BookShelfRemoveHelper  {
    ...
    private void setRemoveWindow(Context context) {//实例化菜单对象
        ...
        popupWindow = new PopupWindow(baseView, WindowManager.LayoutParams.MATCH_PARENT, (int) context.getResources().getDimension(net.lzbook.kit.R.dimen.dimen_view_height_default));
...
//                delete_btn.setTextColor(mContext.getResources().getColor(com.intelligent.reader.R.color.bookshelf_delete_submit_text_color));
