 ...
 */
abstract class RecyclerBaseAdapter<in T>(ctx: Context, private val layoutId: Int) : RecyclerView.Adapter<RecyclerBaseAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        with(holder.itemView) {
            tag = position
            setOnClickListener { listener?.onItemClick(it, it.tag as Int) }
