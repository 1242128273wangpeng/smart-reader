...
public class GridThreeHolder extends AbsRecyclerViewHolder<Book> {
    ...
    public GridThreeHolder(View itemView,
...
//        }
        ...
        if (isRemoveMode) {
            ...
            if (removeMark) {
                theme.resolveAttribute(R.attr.bookshelf_delete_checked2, typeColor, true);
            } else {
                theme.resolveAttribute(R.attr.bookshelf_delete_unchecked2, typeColor, true);
            }
