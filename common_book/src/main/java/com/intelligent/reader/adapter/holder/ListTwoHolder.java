...
public class ListTwoHolder extends AbsRecyclerViewHolder<Book> {

    private final ImageView mCheck;
    private final ImageView mImage;
    private final TextView mName, mUpdateTime, mUnread, mLastChapter;
    private final ImageView mUpdate;


    public ListTwoHolder(View itemView,
        ...
        mUpdate = (ImageView) itemView.findViewById(R.id.book_shelf_status_update);
