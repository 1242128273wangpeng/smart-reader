...
//	private boolean isLeftMoveToLeft;
    ...
    public void dealComputerScorll() {
...
//			if (0 == scrollRemainWidth) {
//				scrollRemainWidth = (int) (readStatus.screenDensity * 10);
//			}
            if (turnToLeft && x > scrollRemainWidth - mWidth
                    || !turnToLeft && x < mWidth - scrollRemainWidth) {
