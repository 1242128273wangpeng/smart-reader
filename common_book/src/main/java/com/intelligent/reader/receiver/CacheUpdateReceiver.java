...
//                onTaskStatusChange();
                ...
                myDialog = new MyDialog(activity, R.layout.dialog_cache_complete_with_err, Gravity.CENTER);
                ...
                txt_title.setText(String.format(activity.getString(R.string.dialog_cache_complete_with_err), book.name));
