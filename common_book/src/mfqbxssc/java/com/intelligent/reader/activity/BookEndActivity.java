...
//    private RelativeLayout bookend_ad_layout;
    ...
    private CardView card_sourcelist;
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    card_sourcelist.setVisibility(View.VISIBLE);
                    ...
                    break;
                case 0:
                    card_sourcelist.setVisibility(View.GONE);
                    if (loadingPage != null) {
                        loadingPage.onSuccess();
                    }
                    break;
    ...
    private void initView() {
        card_sourcelist = (CardView) findViewById(R.id.card_sourcelist);
        sourceListView = (ListView) findViewById(R.id.sourcelist_bookend);
//        sourceListView.setLayerType(View.LAYER_TYPE_SOFTWARE, null);
