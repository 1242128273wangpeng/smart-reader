...
public class BookEndSourceAdapter extends BaseAdapter {

    private Context context;
    private List<Source> data;

    public BookEndSourceAdapter(Context context, List<Source> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_light_book_end_serial_chapter, parent, false);
