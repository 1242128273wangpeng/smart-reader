    ...
    public void startLoadData(int isAuthor) {
        ...
        if (word != null) {
            ...
            if (searchType.equals("2") && isAuthor == 1) {
                ...
                mUrl = RequestService.WEB_AUTHOR.replace("{packageName}", AppUtils.getPackageName())
                        + "?author=" + searchWord;
                try {
                ...
                AppLog.e("kk",
                        searchWord + "==" + searchType + "==" + filterType + "==" + filterWord
                                + "===" + sortType);
                String uri = RequestService.SEARCH_VUE.replace("{packageName}",
    ...
    public void startSearch(String query) {
        ...
        if (finalQuery != null && !TextUtils.isEmpty(finalQuery)) {
            RequestRepositoryFactory.Companion.loadRequestRepositoryFactory(
                    ...
                    .requestAutoCompleteV5(finalQuery,
                            new RequestSubscriber<SearchAutoCompleteBeanYouHua>() {
                                ...
                                public void requestResult(
                                        @Nullable SearchAutoCompleteBeanYouHua bean) {

                                    if (bean != null
                                            && SearchAutoCompleteBeanYouHua.Companion
                                            .getREQUESR_SUCCESS().equals(
                                                    bean.getRespCode()) && bean.getData() != null) {
                                        packageData(bean);
                                    }
