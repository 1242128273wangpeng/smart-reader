...
public class ConfirmDarkPopWindow extends PopupWindow {
    ...
    private ConfirmDarkPopWindow(View inflate, int matchParent, int wrapContent, Builder builder) {
    ...
    public static final class Builder {
        ...
        public Builder confirmButtonName(String confirmButtonName) {
            this.confirmButtonName = confirmButtonName;
            return this;
        }

        public Builder cancelButtonName(String cancelButtonName) {
