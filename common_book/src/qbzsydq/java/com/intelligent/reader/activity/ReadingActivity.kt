...
//import CatalogMarkFragment
//import com.dy.reader.presenter.CatalogMarkPresenter
//import com.dy.reader.presenter.ReadOptionPresenter
...
//        val sourceIds = if (Constants.QG_SOURCE == book.host) book.book_id else book.book_source_id
//        val channelCode = if (Constants.QG_SOURCE == book.host) "1" else "2"
