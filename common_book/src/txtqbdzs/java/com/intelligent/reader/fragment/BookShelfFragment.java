...
public class BookShelfFragment extends Fragment implements UpdateCallBack,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if ("cc.quanbennovel".equals(ACTION_CHKHIDE) || "cc.mianfeinovel".equals(ACTION_CHKHIDE)) {
            isList = false;
        } else {
            isList = true;
        }
        ...
        if (deleteBooks.size() > 0) {
            ...
            base_dialog_abrogate.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    net.lzbook.kit.utils.StatServiceUtils.statAppBtnClick(mContext, net.lzbook.kit.utils.StatServiceUtils.bs_click_delete_ok_btn);
                }
            });
            base_dialog_confirm.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    deleteDialog.dismiss();
                    net.lzbook.kit.utils.StatServiceUtils.statAppBtnClick(mContext, net.lzbook.kit.utils.StatServiceUtils.bs_click_delete_cancel_btn);
                }
            });
            deleteDialog.show();
