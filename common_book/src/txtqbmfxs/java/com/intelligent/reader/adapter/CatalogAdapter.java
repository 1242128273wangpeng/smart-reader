...
public class CatalogAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewCache viewCache;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_book_catalog, parent,
                    false);
            viewCache = new ViewCache(convertView);
            viewCache.catalog_chapter_divider = convertView.findViewById(
                    R.id.catalog_chapter_divider);
