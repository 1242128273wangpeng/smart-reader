...
public class HomeFragment extends BaseFragment implements OnPageChangeListener, FrameBookHelper.SearchUpdateBook, OnClickListener,BookStoreFragment.SearchClickListener {
    ...
    private LinearLayout home_bookshelf_parent;
    private LinearLayout home_bookstore_parent;

    private BookStoreFragment bookStoreFragment;
    private int STYLE_CASE = 0;
    private ImageView content_head_setting;
    private TextView content_title;
    private ImageView content_head_search, content_download_manage, bookshelf_search;
    ...
    protected View getFrameView(LayoutInflater inflater) {
        ...
        if (mFrameView != null) {
            ...
            if (head_two_tab.getVisibility() == View.VISIBLE) {
                ...
                bookshelf_search = (ImageView) mFrameView.findViewById(R.id.bookshelf_search);
                bookshelf_search.setOnClickListener(this);
                home_bookshelf_parent = (LinearLayout) mFrameView.findViewById(R.id.home_bookshelf_parent);
                home_bookstore_parent = (LinearLayout) mFrameView.findViewById(R.id.home_bookstore_parent);
                STYLE_CASE = TOP_TWO_TABS;
                home_bookshelf_parent.setSelected(true);
                home_bookstore_parent.setSelected(false);
...
//            content_community = (ImageView) mFrameView.findViewById(R.id.content_community);
    ...
    private void switchState(boolean isBookShelf) {
        ...
        if (home_bookshelf_parent != null) {
            home_bookshelf_parent.setSelected(isBookShelf);
        }

        if (home_bookstore_parent != null) {
            home_bookstore_parent.setSelected(!isBookShelf);
        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.content_head:
                ...
                break;
            case R.id.bookshelf_search:
                SearchBookActivity.Companion.setIsSatyHistory(false);
                break;
            ...
            case R.id.content_head_search:
                if (shake.check(R.id.content_head_search)){
                    return;
                }
    ...
    protected void initListener() {
        ...
        if (home_bookshelf_parent != null) {
            home_bookshelf_parent.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    setTabSelected(0);
                    bottomType = 1;
        ...
        if (home_bookstore_parent != null) {
            home_bookstore_parent.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
