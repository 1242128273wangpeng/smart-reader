...
import net.lzbook.kit.utils.setDebounceClickListener
...
class GenderHelper(view: View) {
    ...
    private val mBoySelector: ImageView = view.findViewById(R.id.iv_boy_sel) as ImageView
    private val mGirlSelector: ImageView = view.findViewById(R.id.iv_girl_sel) as ImageView
    ...
    private val mBoySection: RelativeLayout = view.findViewById(R.id.rl_section_boy) as RelativeLayout
    private val mGirlSection: RelativeLayout = view.findViewById(R.id.rl_section_girl) as RelativeLayout
    private val mTxtLoading: TextView = view.findViewById(R.id.tv_loading) as TextView
    private val mTxtTitle: TextView = view.findViewById(R.id.tv_title) as TextView
    private val mTxtDesc: TextView = view.findViewById(R.id.tv_desc) as TextView
    private val mTxtStepIn: View = view.findViewById(R.id.tv_step_in) as TextView
...
//        switchDecorate()
    ...
    private fun initListener() {
        mBoySection.setDebounceClickListener(View.OnClickListener {
            selectBoy()
        },4000)
        mGirlSection.setDebounceClickListener(View.OnClickListener {
            selectGirl()
        },4000)
