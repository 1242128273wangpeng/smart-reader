...
public class TagContainerLayout extends ViewGroup {
     ...
     * default 10dp)
     */
    private int mTagHorizontalPadding = 13;
     ...
     */
    private int mTagBorderColor = Color.parseColor("#BBBBBB");
     ...
     */
    private float mTagBdDistance = 0.75f;
...
//        int widthSpecMode = MeasureSpec.getMode(widthMeasureSpec);
        ...
        if (childCount == 0) {
            ...
            setMeasuredDimension(widthSpecSize, mChildHeight * mTagLineMax
            ...
            if (childView.getVisibility() != GONE) {
                ...
                if (mGravity == Gravity.RIGHT) {
                    ...
                    if (curLeft + width - getPaddingLeft() > availableW) {
                        ...
                        curTop += mChildHeight + mVerticalInterval / 2;
                    }
