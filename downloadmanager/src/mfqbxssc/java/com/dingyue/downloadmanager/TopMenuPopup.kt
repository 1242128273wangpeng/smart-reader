...
import kotlinx.android.synthetic.mfqbxssc.popup_download_manager_head_more.view.*
 ...
 */
class TopMenuPopup(private val context: Context) {
    ...
    private val selectedTextColor = Color.parseColor("#882F46")
