...
import kotlinx.android.synthetic.qbmfxsydq.act_download_manager.*
import kotlinx.android.synthetic.qbmfxsydq.item_download_manager_task_header.view.*
        ...
        recl_content.addItemDecoration(DownloadItemDecoration(object : DownloadItemDecoration.DownloadHeaderInterface {
            ...
            override fun requestItemHeaderView(position: Int): View? {
                return if (position > -1 && downloadBooks.size > position) {
                    ...
                    if (position == 0) {
                        view.v_divider.visibility = View.GONE
                    } else {
                        view.v_divider.visibility = View.VISIBLE
                    }
