...
import kotlinx.android.synthetic.qbmfxsydq.popup_download_manager_head_more.view.*
...
class DownloadManagerMenuPopup(context: Context) {
    ...
    private val selectTextColor = Color.parseColor("#000000")
    private val selectedTextColor = Color.parseColor("#1DBFBB")
