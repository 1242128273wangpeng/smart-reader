...
import kotlinx.android.synthetic.txtqbmfxs.act_download_manager.*
import kotlinx.android.synthetic.txtqbmfxs.item_download_manager_task_header.view.*
...
class DownloadManagerActivity : BaseCacheableActivity(), CallBackDownload,
    ...
    private fun initView() {
        ...
        img_head_menu.setOnClickListener {
            topMenuPopup.show(img_head_menu)
        }
        ...
        recl_content.addItemDecoration(DownloadItemDecoration(object : DownloadItemDecoration.DownloadHeaderInterface {
            ...
            override fun requestItemHeaderView(position: Int): View? {
                return if (position > -1 && downloadBooks.size > position) {
                    ...
                    if (finish) {
                        view.txt_state.setBackgroundResource(R.drawable.download_manager_item_header_cache_icon)
                    } else {
                        view.txt_state.setBackgroundResource(R.drawable.download_manager_item_header_nocache_icon)
                    }
    ...
    override fun showMenu() {
        ...
        img_head_menu.visibility = View.GONE
    ...
    override fun dismissMenu() {
        ...
        img_head_menu.visibility = View.VISIBLE
