...
import kotlinx.android.synthetic.zsmfqbxs.popup_download_manager_editor.view.*
...
class RemoveMenuPopup(context: Context, layout: Int = R.layout.popup_download_manager_editor,
    ...
    init {
        ...
        contentView.remove_delete_layout.isFocusable = true
        contentView.remove_delete_layout.isFocusableInTouchMode = true
        contentView.remove_delete_layout.requestFocus()
