...
final class ServiceMethod<R, T> {
    ...
    private final Converter<okhttp3.Response, R> responseConverter;
    ...
    R toResponse(okhttp3.Response body) throws IOException {
        return responseConverter.convert(body);
    }

    /**
     * Inspects the annotations on an interface method to construct a reusable service method. This
     * requires potentially-expensive reflection so it is best to build each service method only
     * once
    ...
    static final class Builder<T, R> {
        ...
        Converter<okhttp3.Response, T> responseConverter;
                ...
                if (partName.isEmpty()) {
                    ...
                    if (Iterable.class.isAssignableFrom(rawParameterType)) {
                        ...
                        Converter<?, RequestBody> converter =
                                retrofit.requestBodyConverter(iterableType,
                                                              annotations,
                                                              methodAnnotations);
                        ...
                        Converter<?, RequestBody> converter =
                                retrofit.requestBodyConverter(arrayComponentType,
                                                              annotations,
                                                              methodAnnotations);
        ...
        private Converter<okhttp3.Response, T> createResponseConverter() {
            Annotation[] annotations = method.getAnnotations();
            try {
