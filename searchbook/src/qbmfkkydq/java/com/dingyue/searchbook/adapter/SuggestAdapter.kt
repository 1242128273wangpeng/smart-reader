    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        //数据填充item
            ITEM_VIEW_TYPE_DATA -> {
                ...
                when (bean.wordtype) {
                    "author" -> holder.iv_icon.setImageResource(R.drawable.search_icon_personal)
                    "label" -> holder.iv_icon.setImageResource(R.drawable.search_icon_bookmark)
                    "name" -> holder.iv_icon.setImageResource(R.drawable.search_icon_book)
                }
