    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        //数据填充item
            ITEM_VIEW_TYPE_DATA -> {
                ...
                when (bean.wordtype) {
                    "author" -> holder.iv_type.setImageResource(R.drawable.search_label_author)
                    "label" -> holder.iv_type.setImageResource(R.drawable.search_label_icon)
                    "name" -> holder.iv_type.setImageResource(R.drawable.search_label_book)
                }
