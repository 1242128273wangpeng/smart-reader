            ...
            ITEM_VIEW_TYPE_DATA -> {
                ...
                when (bean.wordtype) {
                    "author" -> {
                        ...
                        holder.iv_icon.setImageResource(R.drawable.search_label_personal)
                        holder.iv_type.setImageResource(R.drawable.search_label_writer)
                    }
                    "label" -> {
                        holder.iv_shadow.visibility = View.GONE
                        holder.iv_icon.setImageResource(R.drawable.search_label_left)
                        holder.iv_type.setImageResource(R.drawable.search_label_right)
                    }
                    "name" -> {
                        ...
                        Glide.with(context).load(bean.image_url).placeholder(
                                ...
                                R.drawable.book_cover_default).into(holder.iv_icon)

                        holder.iv_type.setImageResource(R.drawable.search_label_book)
                    }
                }
